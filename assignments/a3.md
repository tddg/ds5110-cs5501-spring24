...
* MapReduce Task 2 updated: Each word should be in lowercase. If you
have already downloaded `a3_part2.zip`, please redownload it. 
...
read the code in `single_node_dqn.ipynb`, which hints on how one
could potentially organize control logic code to implement
