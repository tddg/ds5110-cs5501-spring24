...
parent: Assignments
nav_order: 2
due_date: "Friday Feb 14, 11:00am ET"
---
...
* Google Drive enforces throttling since too many people started downloading this dataset in the last minute! To address the gdown issue, simply download the dataset from the [original source](https://www.kaggle.com/datasets/stackoverflow/stacklite). You should use `scp` to copy the downloaded  ZIP file to your EC2 machines: `scp -i vockey.pem <dataset_file_name> ubuntu@<public_IPv4_DNS_address_of_your_EC2>:~/`. 
