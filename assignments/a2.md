...
your assignment and email us problems for debugging, no one will be
able to find you. These assignments are not hard, but some steps might take
longer than you expect, esp. when you are new to it. So, start working on it
**EARLY**.
...
cell of your `.ipynb` into a `.py` file and ensure that it runs
