...
parent: Assignments
nav_order: 3
due_date: "Wednesday Feb 28, 11:00am ET"
---
...
spark = (SparkSession
	.builder
	.appName("DS5110/CS5501: my awesome Spark SQL program")
...
the function [`partitionBy()`](https://spark.apache.org/docs/latest/api/python/reference/api/pyspark.RDD.partitionBy.html)). For this task, add appropriate custom RDD partitioning and see what changes. Your PageRank application should print the first 50 rows with the highest ranks.
...
Spark Worker process. 
	3. Your PageRank application should print the first 50 rows with the highest ranks.
...
* a brief report (filename: `LastName_FirstName_ComputingID_A2_report.pdf`), 
